...
describe('validatePublicHttpUrl', () => {
  ...
  it('rejette une IPv4 hexadécimale 0x7f.0.0.1', () => {
    expect(isBlockedHost('0x7f.0.0.1')).toBe(true);
  });

  it('rejette une IPv4 octale 0177.0.0.1', () => {
  ...
  it('rejette une IPv6 unique locale', () => {
    expect(isBlockedHost('fd00:ec2::254')).toBe(true);
  });

  it('rejette ::ffff:127.0.0.1', () => {
  ...
  it('rejette un helper DNS rebinding nip.io', () => {
    expect(validatePublicHttpUrl('http://127.0.0.1.nip.io/ssrf').ok).toBe(false);
  });
});
...
describe('isBlockedHost', () => {
  ...
  it('bloque lvh.me', () => {
    expect(isBlockedHost('lvh.me')).toBe(true);
  });
