...
import { addHistoryEntry, clearHistory, loadHistory, type HistoryEntry } from '../utils/history';
              ...
              {history.map((entry) => (
                <li key={entry.id}>
                  <button
                    ...
                    className="w-full text-left px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 hover:border-blue-400"
                  >
